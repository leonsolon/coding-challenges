...
# Date: 17-jun-2022
# Description: Code challenge from Lesson 2.1 (CyclicRotation) of Codility
# https://app.codility.com/programmers/
#------------------------------------------------------------------------------

""" An array A consisting of N integers is given. Rotation of the array means that each element is shifted 
 right by one index, and the last element of the array is moved to the first place. For example, the rotation 
...
def solution(A, K):
    ...
    #if (k == 0): return A --> no need for this check
